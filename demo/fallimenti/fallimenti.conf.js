...
var mapConfig = {
    ...
    legend: {
        ...
        description: 'Numero totale di fallimenti',
        delimiter: '-',
    ...
    infowindow: {
        ...
        content: {
            ...
            default: '<p>Questa mappa mostra il numero di fallimenti per Regione ,Provincia, Comune. Non si tratta di tutti i fallimenti ma solo di quelli reperibili sul web. La corrispondenza tra il gradiente di colore e il numero complessivo di fallimenti è dato nella legenda in basso a sinistra.</p>' + 
                ...
                '<li>clicca sul territorio per visualizzare i dati in dettaglio;</li>' + 
            ...
            mobile: '<p>Questa mappa mostra il numero di fallimenti per Regione ,Provincia, Comune</p>',
        },
